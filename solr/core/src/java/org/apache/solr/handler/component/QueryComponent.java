      ...
      if (shardInfo != null) {
        ...
        if (srsp.getException() != null) {
          ...
          if (srsp.getShardAddress() != null) {
            ...
            LOG.info("#### Olli - Got shardAddress in Exception block: " + srsp.getShardAddress() + ". Use them for response?");
          }
        } else {
          ...
          nl.add("shardAddress", srsp.getShardAddress());
          LOG.info("#### Olli - Got shardAddress: " + srsp.getShardAddress() + ". Use them for response?");
        }
